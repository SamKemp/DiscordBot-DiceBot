...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c75 = function(l, expr, r) { return mathjsExpressionParser.eval(text()) },
 ...
 * @private
 */
const notationSymbol$1 = Symbol('notation');
    ...
    if ((notation instanceof Object) && !Array.isArray(notation)) {
      ...
      if (!notation.notation) {
        ...
        if (!Array.isArray(notation.rolls)) {
          ...
          this[rollsSymbol$1] = notation.rolls
            .map((roll) => {
      ...
      // store the notation
      this[notationSymbol$1] = notation.notation;
      ...
      // @todo see if we can assert that the notation is valid
      // store the notation
      this[notationSymbol$1] = notation;
...
export { index$3 as Dice, DiceRoll, DiceRoller, index as Exceptions, index$1 as Modifiers, NumberGenerator$1 as NumberGenerator, Parser, utils as Utils, exportFormats };
