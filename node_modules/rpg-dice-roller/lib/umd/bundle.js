...
(function (global, factory) {
  ...
  var Modifier = /*#__PURE__*/function () {
    ...
    _createClass(Modifier, [{
       ...
       */
      value: function run(results, _dice) {
        return results;
      }
      /* eslint-enable class-methods-use-this */
  ...
  var KeepModifier = /*#__PURE__*/function (_Modifier) {
    ...
    _createClass(KeepModifier, [{
      ...
      value: function run(results, _dice) {
        ...
        ).slice.apply(_map$sort$map, _toConsumableArray(this.rangeToDrop(results))); // loop through all of our dice to drop and flag them as such
      ...
      value: function run(results, _dice) {
        ...
        parsedResults.rolls = results.rolls.map(function (roll) {
          ...
          for (var i = 0; i < _this2.maxIterations && _this2.isComparePoint(compareValue); i++) {
            ...
            var rollResult = _dice.rollOnce(); // update the value to check against
      ...
      value: function run(results, _dice) {
        ...
        results.rolls.map(function (roll) {
          ...
          for (var i = 0; i < _this2.maxIterations && _this2.isComparePoint(roll.value); i++) {
            // re-roll the dice
            var rollResult = _dice.rollOnce(); // update the roll value (Unlike exploding, the original value is not kept)
  ...
  var SortingModifier = /*#__PURE__*/function (_Modifier) {
    ...
    _createClass(SortingModifier, [{
      ...
      value: function run(results, _dice) {
        ...
        sortedResults.rolls = results.rolls.sort(function (a, b) {
  ...
  var RollResult = /*#__PURE__*/function () {
    ...
    _createClass(RollResult, [{
      ...
      get: function get() {
        ...
        return _toConsumableArray(this.modifiers).reduce(function (acc, modifier) {
          var flag;
      ...
      set: function set(value) {
        if ((Array.isArray(value) || value instanceof Set) && _toConsumableArray(value).every(function (item) {
          ...
          this[modifiersSymbol] = new Set(_toConsumableArray(value));
          return;
        }
  ...
  var RollResults = /*#__PURE__*/function () {
    ...
    _createClass(RollResults, [{
      ...
      key: "rolls",
      get: function get() {
        return _toConsumableArray(this[rollsSymbol]);
      }
      /**
       * Set the rolls.
       *
    ...
    _createClass(StandardDice, [{
      ...
      get: function get() {
        if (this[modifiersSymbol$1]) {
          ...
          return new Map(_toConsumableArray(this[modifiersSymbol$1]).sort(function (a, b) {
      ...
      set: function set(value) {
        ...
        this[modifiersSymbol$1] = modifiers; // loop through each modifier and ensure that those that require it have compare points
        // @todo find a better way of defining compare point on modifiers that don't have them

        /* eslint-disable no-param-reassign */

        this[modifiersSymbol$1].forEach(function (modifier) {
          if (modifier instanceof ExplodeModifier && !modifier.comparePoint) {
            modifier.comparePoint = new ComparePoint('=', _this2.max);
          } else if (modifier instanceof ReRollModifier && !modifier.comparePoint) {
            modifier.comparePoint = new ComparePoint('=', _this2.min);
          }
        });
        /* eslint-enable */
      }
  ...
  */
  ...
  getCjsExportFromNamespace(polyfills);
  ...
  var _string = _interopRequireDefault(string$1);
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      return new PercentileDice(qty || 1);
        ...
        peg$c20 = function peg$c20(qty, sides) {
      ...
      return new CriticalFailureModifier(comparePoint);
        ...
        peg$c54 = function peg$c54(dir) {
      return new SortingModifier(dir || 'a');
    },
        peg$c55 = "f",
        peg$c56 = peg$literalExpectation("f", false),
        peg$c57 = function peg$c57(comparePoint) {
      return comparePoint;
    },
        peg$c58 = function peg$c58(operator, value) {
      return new ComparePoint(operator, value);
        ...
        peg$c75 = function peg$c75(l, expr, r) {
      return mathjsExpressionParser.eval(text());
    },
      ...
      return [].concat(_toConsumableArray(head), _toConsumableArray(tail.map(function (_ref3) {
        ...
        peg$c77 = function peg$c77(l, expr, r) {
  ...
  var calculateTotalSymbol = Symbol('calculateTotal');
  /**
   * The notation
   *
   * @type {symbol}
  ...
  var notationSymbol$1 = Symbol('notation');
  /**
  ...
  var parsedNotationSymbol = Symbol('parsed-notation');
  /**
  ...
  var DiceRoll = /*#__PURE__*/function () {
      ...
      if (notation instanceof Object && !Array.isArray(notation)) {
        ...
        if (!notation.notation) {
          ...
          if (!Array.isArray(notation.rolls)) {
            ...
            throw new TypeError("Rolls must be an array: ".concat(notation.rolls));
          } else {
            // if roll is a RollResults, return it, otherwise try to convert to a RollResults object
            this[rollsSymbol$1] = notation.rolls.map(function (roll) {
        ...
        this[notationSymbol$1] = notation.notation; // parse the notation

        this[parsedNotationSymbol] = Parser.parse(this.notation);

        if (!this[rollsSymbol$1] || !this[rollsSymbol$1].length) {
          // ensure rolls is an empty array
          this[rollsSymbol$1] = []; // roll the dice
        ...
        // @todo see if we can assert that the notation is valid
        // store the notation
        this[notationSymbol$1] = notation; // empty the current rolls

        this[rollsSymbol$1] = []; // parse the notation

        this[parsedNotationSymbol] = Parser.parse(this.notation); // roll the dice
    ...
    _createClass(DiceRoll, [{
      ...
      value: function roll() {
        ...
        this[rollsSymbol$1] = this[rollMethodSymbol](); // return the rolls;
      ...
      value: function value(rolls) {
        ...
        this[parsedNotationSymbol].forEach(function (item) {
          ...
          if (item instanceof StandardDice) {
            ...
            formula += rolls[rollIndex] ? rolls[rollIndex].value : 0; // increment the roll index and store the previous rolls / parsed die
        ...
        return formula ? toFixed(mathjsExpressionParser.eval(formula), 2) : 0;
      }
      /**
      ...
      value: function value(engine) {
        ...
        var rolls = this[parsedNotationSymbol].map(function (item) {
      ...
      get: function get() {
        ...
        if (this.hasRolls()) {
          output += this[parsedNotationSymbol].map(function (item) {
            if (item instanceof StandardDice) {
              var rollResults = _this.rolls[rollIndex] || null; // increment the roll index
